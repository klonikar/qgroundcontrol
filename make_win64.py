...
if __name__ == '__main__':
	...
	ignoreFiles = ['MockLink.cc', 'BluetoothLink.cc', 'MockLinkMissionItemHandler.cc', 
				   ...
				   'aes.cpp', 'GStreamer.cc', 'GstVideoReceiver.cc', 'xz_dec_syms.c',
				   'gstqgc.c', 'TestBrowser.cpp', 'gstqgcvideosinkbin.c', 'qserialport_android.cpp',
